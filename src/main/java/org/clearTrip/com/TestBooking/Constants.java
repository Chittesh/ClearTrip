...
public class Constants {
	...
	public static final int expectedTravelModeCount = 3;
	public static final String expectedAdultDropDownValue = "1";
	public static final String expectedChildDropDownValue = "0";
	public static final String expectedInfantDropDownValue = "0";
	public static final String expectedAdultDefaultValue = "> 12 yrs";
